...
headers_temp_dir="./merlin-transcript/headers"
mkdir -p $headers_temp_dir
cp "./merlin-transcript/Generated/SwiftBridgeCore.h" $headers_temp_dir
cp "./merlin-transcript/Generated/merlin-transcript/merlin-transcript.h" $headers_temp_dir
